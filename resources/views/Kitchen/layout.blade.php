...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Kitchen Panel</span>
    </a>
  ...
  <div class="content-wrapper position-relative">
    <div style="z-index: 100; width:350px;" class=" d-none shadow card bg-light position-absolute top-0 start-50 translate-middle-x" id="category_form">
        <div class="card-body">
            <form action="{{ route('kitchen#categoryCreate') }}" method="post">
                @csrf
                <label for="">Category Name</label>
                <input name="name" type="text" placeholder="Category Name..." class=" form-control mb-3">
                @error('name')
